...
public class PasswordHandler {
    ...
    protected static User authenticateUser(Scanner scanner, List<User> staff, List<Patient> patients) {
    ...
    protected static void updateStaffList(List<User> staff, String filePath) {
